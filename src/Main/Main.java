...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException {
        ...
        //Dataset reading
//        Data.ReadTrain("/home/mario/ieee/input/train_final.csv", 590540, 433, ",");
//        Data.ReadTest("/home/mario/ieee/input/final_test.csv", 506691, 432, ",");
...
//        Data.ReadTest("datasets/santander/test.csv", 200000, 199, ",");
        ...
        if (forest) {
            ...
            Forest f = new Forest();
            f.crossValidate(iterations, forestSize, seed, metric, nFolds, featureFrac, samplesFrac);
            f.predict();
//            Data.WritePredictions("../datasets/titanic/sub.csv", "../datasets/titanic/gender_submission.csv", f.preds);
            ...
            RegressionTree rwt;
            rwt = new RegressionTree(iterations, seed, metric, featureFrac, samplesFrac);
            for (int i = 0; i < nFolds; i++) {
                rwt.setValidationSets(kfold.getTrainIndexes()[i], kfold.getValidIndexes()[i]);
                rwt.train();
                mean += rwt.getResult();
